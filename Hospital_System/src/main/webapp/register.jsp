				...
				<div class="col-12 col-lg-9 col-xl-7">
					<div class="card shadow-2-strong" style="border-radius: 15px;">
						<div class="card-body p-4 p-md-5 text-center"
							...
							<h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-center">Register
								Form</h3>
							<h2>${success}</h2>
							<form action="AdminServlet" method="post">
								...
								<div class="form-outline ">
									...
									<div style="margin-top: 20px; color: red; font-size: 24px;"">
										<span>Already have an  account?<a href="index.jsp"
											class="text-decoration-none text-success">Login</a></span>
									</div>
							</form>
						</div>
					</div>
